...
data:
  ...
  verifiedWith: []
documentation_of: code/extra_output.cc
layout: document
redirect_from:
- /library/code/extra_output.cc
- /library/code/extra_output.cc.html
